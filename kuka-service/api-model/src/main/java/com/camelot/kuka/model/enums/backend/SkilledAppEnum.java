...
public enum SkilledAppEnum implements BaseEnum {
    ...
    private SkilledAppEnum(Integer code, String description) {
        this.code = code;
     ...
     * Copyright (c) 2019 北京柯莱特科技有限公司
     **/
    public static SkilledAppEnum get(Integer code) {
        if (code == null) {
            return null;
        }
     ...
     * Copyright (c) 2019 北京柯莱特科技有限公司
     **/
    public static SkilledAppEnum get(String description) {
